...
public class RedisDaoTest {
    ...
    @Autowired
    private RedisDao<Map<String,String>> redisUtils;
    @Test
    public void contextLoads() {
        ...
        redisUtils.setObject("map",map,1000);
        Map<String,String> outMap = redisUtils.getObject("map",new TypeReference<Map<String,String>>(){});
    }
}